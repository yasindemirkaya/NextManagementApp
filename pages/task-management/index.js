...
const Projects = () => {
    ...
    // Task Management menüsünü ve alt menülerini bul
    const TasksMenu = sidebarMenu.find(menu => menu.name === "Tasks");

    return (
        <div className="container mt-5">
            <h1 className="mb-4">{t("Tasks")}</h1>
            <Row>
                {TasksMenu?.subMenus.map(subMenu => (
