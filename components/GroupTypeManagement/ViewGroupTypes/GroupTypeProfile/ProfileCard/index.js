                ...
                <Card className={styles.profileCard}>
                    <Card.Body>
                        ...
                        <div className={styles.profileInfo}>
                            ...
                            <p className={styles.infoText}>*{t("This group type is created by")} <b>{groupType.created_by}</b></p>
                            <p className={styles.infoText}>*{t("The last update for this group type is made by")} <b>{groupType.updated_by}</b></p>
                        </div>
